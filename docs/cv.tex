...
\usepackage{amsfonts}
\usepackage[left=1.3cm,right=1.3cm,top=0.8cm,bottom=1.5cm]{geometry}
\usepackage{palatino}
\usepackage{fancyhdr}
\usepackage{hyperref}
...
\begin{center}
\begin{tabular}{lr}
& \textsc{Curriculum Vitae - Jan 2020} \\
...
& \multicolumn{4}{l}{\textquotedblleft Inference in Time Series Models using Smoothed Clustered Standard Errors\textquotedblright}\\
 & \multicolumn{4}{l}{(with Timothy J. Vogelsang), \emph{revise \& resubmit, Journal of Econometrics}} \vspace{0.1cm}\\
...
\begin{tabular}{llllr}
\multicolumn{5}{r}{\textsc{Seunghwa Rho - Jan 2020}} \\ \hline
\multicolumn{5}{p{500pt}}{}\\
\end{tabular}
