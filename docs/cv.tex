...
\usepackage{amsfonts}
\usepackage[left=1.3cm,right=1.3cm,top=0.7cm,bottom=1.5cm]{geometry}
\usepackage{palatino}
\usepackage{fancyhdr}
\usepackage{hyperref}
...
\begin{center}
\begin{tabular}{lr}
& \textsc{Curriculum Vitae - May 2020} \\
...
& \multicolumn{4}{l}{\textquotedblleft Inference in Time Series Models using Smoothed Clustered Standard Errors\textquotedblright, (with Timothy J. Vogelsang)}\\
 & \multicolumn{4}{l}{\,\,\,\emph{revise \& resubmit, Journal of Econometrics}} \vspace{0.1cm}\\
...
& \multicolumn{4}{l}{\textquotedblleft Estimation of Long Memory Models\textquotedblright \ (with Richard T. Baillie \& Dooyeon Cho)} \vspace{0.1cm}\\
\multicolumn{5}{p{500pt}}{}\\
...
\begin{tabular}{llllr}
\multicolumn{5}{r}{\textsc{Seunghwa Rho - May 2020}} \\ \hline
\multicolumn{5}{p{500pt}}{}\\
\end{tabular}
...
& \multicolumn{4}{l}{\quad Regression Analysis (UG, MA), Microeconometrics (PhD)}\vspace{0.1cm}\\
\multicolumn{5}{l}{} \\
