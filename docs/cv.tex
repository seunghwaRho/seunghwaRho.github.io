...
\begin{center}
\begin{tabular}{lr}
& \textsc{Curriculum Vitae - June 2020} \\
...
& \multicolumn{4}{l}{\textquotedblleft Inference in Time Series Models using Smoothed Clustered Standard Errors\textquotedblright, (with Timothy J. Vogelsang),}\\
 & \multicolumn{4}{l}{\,\,\,\emph{conditionally accepted, {\bf \emph{ Journal of Econometrics}}}} \vspace{0.1cm}\\
...
\begin{tabular}{llllr}
\multicolumn{5}{r}{\textsc{Seunghwa Rho - June 2020}} \\ \hline
\multicolumn{5}{p{500pt}}{}\\
\end{tabular}
