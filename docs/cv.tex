...
\usepackage{amsfonts}
\usepackage[left=1.3cm,right=1.3cm,top=0.7cm,bottom=1.4cm]{geometry}
\usepackage{palatino}
\usepackage{fancyhdr}
\usepackage{hyperref}
...
\begin{center}
\begin{tabular}{lr}
& \textsc{Curriculum Vitae - Aug 2022} \\
\multicolumn{2}{c}{{\Large \textsc{\textbf{Seunghwa \ Rho }}}}\\ 
\multicolumn{2}{p{510pt}}{}\\
\hline\\
MLB 408  & E-mail: \href{mailto:serho@emory.edu}{serho@emory.edu} \\
...
& \multicolumn{4}{l}{"The Costs of Using Low Order Autoregressions to Represent Fractionally Integrated Processes with Application }\vspace{0.1cm}\\
& \multicolumn{4}{l}{\,\,\, realized Volatility" (with Richard T. Baillie and Dooyeon Cho)} \vspace{0.1cm}\\
& \multicolumn{4}{l}{\textquotedblleft Generalized Quantile Random Forest with Smoothed Estimating Equations\textquotedblright } \\
& \multicolumn{4}{l}{\textquotedblleft Physical and mental burden among Hispanic caregivers caring for elderly with stroke and multimorbidity\textquotedblright }\\
...
\begin{tabular}{ccccc}
\multicolumn{5}{r}{\textsc{Seunghwa Rho - Aug 2022}} \vspace{0.2cm}\\ \hline
\multicolumn{5}{p{500pt}}{}\\\\
\end{tabular}
...
\clearpage
\begin{tabular}{llllr}
\multicolumn{5}{r}{\textsc{seunghwa Rho - Aug 2022}} \\ \hline
\multicolumn{5}{p{500pt}}{}
\end{tabular}
%
