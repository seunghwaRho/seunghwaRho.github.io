...
\begin{center}
\begin{tabular}{lr}
& \textsc{Curriculum Vitae - March 2021} \\
...
& \multicolumn{4}{l}{\textquotedblleft On Asymmetric Volatility Effects in Currency Markets\textquotedblright \ (with Dooyeon Cho),\,\emph{R\&R, Empirical Economics}} \vspace{0.1cm}\\
...
\begin{tabular}{llllr}
\multicolumn{5}{r}{\textsc{Seunghwa Rho - March 2021}} \vspace{0.2cm}\\ \hline
\multicolumn{5}{p{500pt}}{}\\\\
\end{tabular}
