...
\begin{center}
\begin{tabular}{lr}
& \textsc{Curriculum Vitae - May 2022} \\
...
&\multicolumn{4}{l}{\,\,\,(with Richard T. Baillie \& Dooyeon Cho),\,\, \emph{accepted}, {\bf \emph{Econometrics and Statistics}} }\vspace{0.1cm}\\
& \multicolumn{4}{l}{\textquotedblleft Reassessing Growth Vulnerability\textquotedblright \ (with Dooyeon Cho), \emph{submitted}} \vspace{0.1cm}\\
...
\begin{tabular}{llllr}
\multicolumn{5}{r}{\textsc{Seunghwa Rho - May 2022}} \vspace{0.2cm}\\ \hline
\multicolumn{5}{p{500pt}}{}\\\\
\end{tabular}
