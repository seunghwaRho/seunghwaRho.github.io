...
\begin{center}
\begin{tabular}{lr}
& \textsc{Curriculum Vitae - December 2020} \\
...
&\multicolumn{4}{l}{\,\,\,(with Richard T. Baillie \& Dooyeon Cho)}\vspace{0.1cm}\\
...
\begin{tabular}{llllr}
\multicolumn{5}{r}{\textsc{Seunghwa Rho - December 2020}} \vspace{0.2cm}\\ \hline
\multicolumn{5}{p{500pt}}{}\\\\
\end{tabular}
